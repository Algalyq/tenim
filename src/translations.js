...
export const translations = {
  ...
  ru: {
    ...
    learnEnglish: 'Пройди IELTS',
    englishLanguage: 'БЕСПЛАТНО',
    throughLove: 'после наших курсов',
  ...
  kz: {
    ...
    learnEnglish: 'IELTS-тен',
    englishLanguage: 'ТЕГІН',
    throughLove: 'Өт біздің курстардан кейін',
