...
const PriceList = () => {
  ...
  const content = {
    ru: {
      ...
      miniGroup: {
        title: 'МИНИ-ГРУППА (до 4 человек)',
        description: [
          '📌 Общение, практика, мотивация',
      ...
      daily: {
        title: 'КАЖДЫЙ ДЕНЬ (индивидуально)',
        description: [
    ...
    kz: {
      ...
      miniGroup: {
        title: 'МИНИ-ТОП (4 адамға дейін)',
        description: [
          '📌 Қарым-қатынас, тәжірибе, мотивация',
