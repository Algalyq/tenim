  ...
  const content = {
    ru: {
      ...
      individual: {
        ...
        options: [
          '2 раза в неделю по 60 мин — 28 000 ₸/мес',
          '3 раза в неделю по 60 мин — 39 000 ₸/мес'
        ]
      },
      miniGroup: {
        title: 'МИНИ-ГРУППА',
        ...
        options: [
          '2 раза в неделю по 80 мин — 21 600 ₸/мес',
          '3 раза в неделю по 80 мин — 30 000 ₸/мес'
        ]
      },
      pair: {
        ...
        options: [
          '2 раза в неделю по 60 мин — 24 000 ₸/мес с чел.',
          '3 раза в неделю по 60 мин — 35 000 ₸/мес с чел.'
        ]
      },
      daily: {
        title: 'КАЖДЫЙ ДЕНЬ',
    ...
    kz: {
      ...
      individual: {
        ...
        options: [
          'Аптасына 2 рет, 60 минут – 28 000 ₸/ай',
          'Аптасына 3 рет, 60 минут – 39 000 ₸/ай'
        ]
      },
      miniGroup: {
        title: 'МИНИ-ТОП',
        ...
        options: [
          'Аптасына 2 рет, 80 минут – 21 600 ₸/ай',
          'Аптасына 3 рет, 80 минут – 30 000 ₸/ай'
        ]
      },
      pair: {
        ...
        options: [
          'Аптасына 2 рет, 60 минут – 24 000 ₸/ай (адам басына)',
          'Аптасына 3 рет, 60 минут – 35 000 ₸/ай (адам басына)'
        ]
      },
      daily: {
        title: 'КҮН САЙЫН',
